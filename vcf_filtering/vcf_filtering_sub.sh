...
min_dp=5
mean_dp=5
sbatch --output=$vcf_dir/logFiles/01_filter_min-dp.$set_id.oe $scripts_dir/01_filter_min-dp.sh $vcf_raw $min_dp $mean_dp $vcf_dir/$set_id.populations.snps.01filt.vcf
...
sbatch -output=$vcf_dir/logFiles/02_filter_missing-1.$set_id.oe $scripts_dir/02_filter_missing-1.sh \
...
suffix=auto
sbatch --output=$vcf_dir/logFiles/03_annot_gatk.$set_id.oe $scripts_dir/03_annot_gatk.sh \
...
sbatch --output=$vcf_dir/logFiles/04_filter_gatk.$set_id.oe $scripts_dir/04_filter_gatk.sh \
...
sbatch --output=$vcf_dir/logFiles/05_filter_max-dp.$set_id.oe $scripts_dir/05_filter_max-dp.sh \
...
sbatch --output=$vcf_dir/logFiles/06_filter_missing-2.$set_id.oe $scripts_dir/06_filter_missing-2.sh \
...
mac=3
sbatch --output=$vcf_dir/logFiles/07_filter_mac.$set_id.oe $scripts_dir/07_filter_mac.sh \
...
sbatch --output=$vcf_dir/logFiles/08_drop_inds.$set_id.oe $scripts_dir/08_drop_inds.sh \
